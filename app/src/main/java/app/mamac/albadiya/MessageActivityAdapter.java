...
public class MessageActivityAdapter extends BaseAdapter {
    ...
    public MessageActivityAdapter(Context context,ArrayList<ChatMember> chats){
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        MessageActivityAdapter.Holder holder=new MessageActivityAdapter.Holder();
...
//        description.setText(chats.get(position).description);
        ...
        if(chats.get(position).id.equals(Settings.GetUserId(context))) {
            ...
            holder.chating_right.setText(chats.get(position).message);
            ...
            holder.item_image.setVisibility(View.GONE);
            holder.chating_left.setText(chats.get(position).message);
            holder.chat_date_time.setText(chats.get(position).date);
            Picasso.with(context).load(chats.get(position).file).into(holder.item_image);
