...
public class AlbadiyaTimelineFragment extends BaseToroFragment implements FacebookPlaylistFragment.Callback,AbsListView.OnScrollListener{
    ...
    LinearLayout header;
    TextView language;
    String post_id,main_header,horizontal_line;
    LinearLayout line;
