...
//    });
    ...
    if (fragment.get_like_id(((TimelineItem)object).getAuthor().getUserId())) {
      ...
      public void onClick(View v) {
        Ion.with(itemView.getContext())
                ...
                .setCallback(new FutureCallback<JsonObject>() {
                  @Override
                  public void onCompleted(Exception e, JsonObject result) {
                    fragment.set_like_id(((TimelineItem)object).getAuthor().getUserId());
                    fragment.set_like_count(((TimelineItem)object).getAuthor().getUserId());

                    if (fragment.get_like_id(((TimelineItem)object).getAuthor().getUserId())) {
                      user_like.setBackgroundResource(R.drawable.with);
                      no_of_likes.setText( fragment.get_like_count(((TimelineItem)object).getAuthor().getUserId()));
    ...
    mThumbnailUser.setOnClickListener(new View.OnClickListener() {
      @Override
      public void onClick(View view) {
        fragment.go_to_user_profile(((TimelineItem) object).getAuthor().getPersonId());
      }
    });
