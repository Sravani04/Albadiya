...
public abstract class TimelineViewHolder extends ToroAdapter.ViewHolder {
  ...
  static ToroAdapter.ViewHolder createViewHolder(ViewGroup parent, int type, AlbadiyaTimelineFragment fragment) {
    if (inflater == null) {
